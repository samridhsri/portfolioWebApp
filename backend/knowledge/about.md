...
**AI/ML Engineering** — Building production-grade systems with large language models, fine-tuning transformers, implementing RAG pipelines, and optimizing inference performance.

**Full-Stack Development** — Creating end-to-end solutions with modern frameworks (React, FastAPI, Django, Node.js) and deploying scalable applications on cloud platforms.

**Computer Vision & NLP** — Developing intelligent vision systems for real-world applications and natural language processing workflows.

## What Drives Me

I'm driven by the intersection of AI and practical engineering. I believe the best solutions combine cutting-edge AI research with robust, production-ready code. I'm passionate about:
...
I'm actively looking for entry-level AI/ML engineering roles where I can contribute my skills in LLM systems, computer vision, and full-stack development. Feel free to reach out if you'd like to discuss potential opportunities or collaborate on interesting projects!